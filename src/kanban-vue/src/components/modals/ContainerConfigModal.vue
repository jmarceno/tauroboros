          ...
          <div class="section">
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between py-1 border-b border-dark-surface3">
                ...
                <code class="text-xs bg-dark-surface px-2 py-0.5 rounded">.pi/easy-workflow/Dockerfile.generated</code>
              </div>
              <div class="flex justify-between py-1 border-b border-dark-surface3">
                <span class="text-dark-text-muted">Custom Dockerfile:</span>
                <code class="text-xs bg-dark-surface px-2 py-0.5 rounded">.pi/easy-workflow/Dockerfile.custom</code>
              </div>
            </div>
          </div>
