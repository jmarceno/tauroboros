...
export function ContainersTab() {
  ...
  useEffect(() => {
    ...
    loadData()
  }, [loadContainerStatus, loadProfiles, loadBuilds, loadImages])
        ...
        {activeTab === 'build' && (
          <div className="space-y-6">
            ...
            <div className="form-group">
              ...
              <textarea
                className="form-textarea font-mono text-xs min-h-[300px]"
                disabled={isBuilding}
            ...
            <div>
              ...
              {builds.length === 0 ? (
                <div className="text-sm text-dark-text-muted bg-dark-surface rounded-lg p-4 text-center">
                ...
                <div className="space-y-2">
                  {builds.slice(0, 5).map((build) => (
                    <div
                      key={build.id}
                      className="flex items-center justify-between p-3 bg-dark-surface rounded-lg text-sm cursor-pointer hover:bg-dark-surface3 transition-colors"
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-dark-text font-mono text-xs">{build.imageTag}</span>
